...
const Flexbox = props => {
  return (
    <div id="flexbox">
      ...
      <Card imgUrl="https://tse1.mm.bing.net/th?id=OIP.NhV4BAbXK-KtznZSsbygMQHaE2&pid=Api" />
      <Card imgUrl="http://3.bp.blogspot.com/-DiuhxcjAZQM/TmOZWHcPJzI/AAAAAAAAAzU/DXHiYryXZ5M/s1600/red_panda_1.jpg" />
      <Card imgUrl="https://tse2.mm.bing.net/th?id=OIP.wyttLcrLj-6GpJkulGaqigHaKw&pid=Api" />
    </div>
  );
};
